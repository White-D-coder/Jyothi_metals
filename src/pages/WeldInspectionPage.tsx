...
const specifications = [
  { label: 'NDT Standard Compliance', value: 'ASME Sec V, EN ISO 17640, ASTM A388, API 1104, BS EN 10228' },
  { label: 'Defect Detection Threshold', value: 'Sub-surface inclusions & weld laminations down to 0.1mm' },
  { label: 'Probe Technology', value: 'Phased-Array Ultrasonic (PAUT) 1MHz – 15MHz multi-element transducers' },
  { label: 'Complementary NDT Methods', value: 'Radiographic (X-Ray), Dye Penetrant (DPT), Magnetic Particle (MPI)' },
  { label: 'Inspector Certification', value: '100% in-house inspection conducted by ASNT Level II & III certified personnel' },
  { label: 'Documentation Output', value: 'EN 10204 3.1 / 3.2 NDT Inspection Certificate + Digital Scan Records' },
];
